...
(A) .Rmd Line numbers where at least two different data sources are imported: 49 / 173



(B) .Rmd Line numbers for inspecting data intake: 55 / 179
...
(A) .Rmd Line number(s) for general data wrangling: 70~76, 188~192


(B) .Rmd Line number(s) for a join operation: 142


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent): 116 ~ 134 (equiavlanet to gather)


(D) .Rmd Line number(s) for use of regular expressions: 68~76, 191


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 96, 120, 131, 212
...
Only few examples are written here. There are more in the codes. I was not able to find every single use of each data wrangling.
...
(A) .Rmd Line number(s) for use of mulitple different geoms: 84-89, 95-101, 151-158, 200-205, 211-218 

(B) .Rmd Line number(s) for use of multiple aesthetics: 84-89, 95-101, 151-158, 200-205, 211-218 

(C) .Rmd Line number(s) for use of layered graphics: 151-158, 211-218
